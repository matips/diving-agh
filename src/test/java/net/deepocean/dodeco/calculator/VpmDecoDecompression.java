...
/**
 * This class represents the VPMDECO (2001) decompression algorithm. 
 * This alogorith originally was developed in Fortran 
 * by Erik C. Baker. The comments between === lines  are copied comments
 * from the original authors.
 */

public class VpmDecoDecompression extends Decompression
{
     ...
     *  @exception      CalculationException is thrown when a calculation error occurs
     */
...
/* ===============================================================================  */
    ...
    {
        decoStopDepth=(Length)decoCeilingDepth.clone();
...
/* =============================================================================== */
        ...
        while (elements.hasMoreElements())
        {
            ...
            {
                weighted_allowable_gradient =
                    (allowable_gradient_he * inspired_helium_pressure +
                        allowable_gradient_n2 * inspired_nitrogen_pressure) /
